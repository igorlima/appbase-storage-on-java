...
// https://devcentral.f5.com/articles/ssl-trust-provider-for-java
    ...
    public static void main(String[] args) throws UnirestException {
      XTrustProvider.install();
        HttpResponse<String> response = Unirest
          .put("https://scalr.api.appbase.io/talks_2016/getting_started/7")
          .basicAuth("aWSlJvIUk", "58e3edd6-8933-4f61-a648-231c0404d4d7")
          .body("{\"id\": 7, \"title\": \"Test 7\"}")
          .asString();
